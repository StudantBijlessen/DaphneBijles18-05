...
def main():
    ...
    for line in lees_in.readlines():
        line=line.replace('∖n','') #waarom moesten we dit ook al weer doen? 
        ...
        if lineNumber%5==0:
            ...
            personen.append(naam,geslacht,lengte,haarkleur,huisdier)#waarom moet ik dit zo laten inspringen?
        
        lineNumber +=1

    schrijf_weg=open('bmdwk.txt','w+')
#Vraag1
    persoonNr=0
...
#Vraag2
    ...
    for persoon in personen:
        if persoon[4]=='Siamese kat':
            lengtes_mensen_siamese_kas.append(persoon[2])
